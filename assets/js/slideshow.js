...
function showDivs(n) {
    ...
    if(document.getElementById("btntxt" + slideIndex).value != "")
    {
      ...
      document.getElementById("slide_btn").innerHTML = document.getElementById("btntxt" + slideIndex).value;
      document.getElementById("slide_btn").href = document.getElementById("btnlnk" + slideIndex).value;
    }else{
